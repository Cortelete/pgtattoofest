...
const Modal: React.FC<ModalProps> = ({ isOpen, onClose, children }) => {
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-lg bg-red-950/90 border border-red-700/50 rounded-xl shadow-2xl shadow-red-800/50 text-white p-6 m-4 transform transition-all duration-300 scale-95 opacity-0 animate-fade-in-scale"
