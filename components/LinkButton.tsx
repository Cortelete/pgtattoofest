...
const LinkButton: React.FC<LinkButtonProps> = ({ icon, text, onClick }) => {
  return (
    <button
      onClick={onClick}
      className="group w-full flex items-center p-4 my-2 bg-black bg-opacity-30 backdrop-blur-sm border border-purple-500/50 rounded-lg text-white text-base md:text-lg font-semibold transition-all duration-300 ease-in-out transform hover:scale-105 hover:bg-purple-800/50 hover:shadow-lg hover:shadow-purple-500/50 focus:outline-none focus:ring-2 focus:ring-orange-500"
    >
